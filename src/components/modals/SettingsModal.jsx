        ...
        <div className="px-6 flex gap-1 overflow-x-auto overflow-y-hidden shrink-0 shadow-[inset_0_-1px_0_#E8E8E8]" style={{ scrollbarWidth: 'thin' }}>
          {tabs.map(tab => (
            <button
              ...
              className={`px-3 py-2.5 rounded-t-xl font-bold text-xs sm:text-sm transition-colors whitespace-nowrap flex items-center gap-1.5 border ${activeTab === tab.key
